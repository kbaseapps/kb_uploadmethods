...
class kb_uploadmethodsTest(unittest.TestCase):
  ...
  @patch.object(UnpackFileUtil, "_file_to_staging", 
                                        side_effect=mock_file_to_staging)
  ...
  def test_genbank_to_genome(self, download_staging_file):
    ...
    self.assertTrue(ref[0].has_key('genome_ref'))
    self.assertTrue(ref[0].has_key('genome_info'))
    self.assertTrue(ref[0].has_key('report_ref'))
    self.assertTrue(ref[0].has_key('report_name'))
