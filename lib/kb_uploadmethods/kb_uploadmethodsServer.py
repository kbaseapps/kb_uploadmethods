...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_kb_uploadmethods.import_condition_set_from_staging,
                             name='kb_uploadmethods.import_condition_set_from_staging',
                             types=[dict])
        self.method_authentication['kb_uploadmethods.import_condition_set_from_staging'] = 'required'  # noqa
