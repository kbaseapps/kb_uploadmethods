...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_kb_uploadmethods.import_sra_from_web,
                             ...
                             types=[dict])
        self.method_authentication['kb_uploadmethods.import_sra_from_web'] = 'required'  # noqa
        ...
        self.rpc_service.add(impl_kb_uploadmethods.import_file_as_fba_model_from_staging,
                             name='kb_uploadmethods.import_file_as_fba_model_from_staging',
                             types=[dict])
        self.method_authentication['kb_uploadmethods.import_file_as_fba_model_from_staging'] = 'required'  # noqa
        ...
        self.rpc_service.add(impl_kb_uploadmethods.import_reads_from_staging,
                             ...
                             types=[dict])
        self.method_authentication['kb_uploadmethods.import_reads_from_staging'] = 'required'  # noqa
        self.rpc_service.add(impl_kb_uploadmethods.import_tsv_as_phenotype_set_from_staging,
        ...
        self.rpc_service.add(impl_kb_uploadmethods.import_eschermap_from_staging,
        ...
        self.rpc_service.add(impl_kb_uploadmethods.import_fasta_as_protseqset_from_staging,
                             name='kb_uploadmethods.import_fasta_as_protseqset_from_staging',
                             types=[dict])
        self.method_authentication['kb_uploadmethods.import_fasta_as_protseqset_from_staging'] = 'required'  # noqa
