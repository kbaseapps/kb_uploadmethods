...
class ConditionUtils(object):
    ...
    def get_conditions(self, params, context=None):
        ...
        """
        return self._client.run_job('ConditionUtils.get_conditions',
    ...
    def file_to_condition_set(self, params, context=None):
        ...
        """
        return self._client.run_job('ConditionUtils.file_to_condition_set',
                                    [params], self._service_ver, context)
    ...
    def condition_set_to_tsv_file(self, params, context=None):
        ...
        """
        return self._client.run_job('ConditionUtils.condition_set_to_tsv_file',
                                    [params], self._service_ver, context)
    ...
    def export_condition_set_tsv(self, params, context=None):
        ...
        """
        return self._client.run_job('ConditionUtils.export_condition_set_tsv',
                                    [params], self._service_ver, context)
    ...
    def export_condition_set_excel(self, params, context=None):
        ...
        :returns: instance of type "ExportConditionSetOutput" -> structure:
           parameter "shock_id" of String
        """
        return self._client.run_job('ConditionUtils.export_condition_set_excel',
                                    [params], self._service_ver, context)

    def status(self, context=None):
        return self._client.run_job('ConditionUtils.status',
