...
public class Params {
    ...
    public Params withFirstFastqFileName(String firstFastqFileName) {
        this.firstFastqFileName = firstFastqFileName;
        return this;
    }
    ...
    public Params withSecondFastqFileName(String secondFastqFileName) {
        this.secondFastqFileName = secondFastqFileName;
        return this;
    }
    ...
    public Params withFirstFastqFileUrl(String firstFastqFileUrl) {
        this.firstFastqFileUrl = firstFastqFileUrl;
        return this;
    }
    ...
    public Params withSecondFastqFileUrl(String secondFastqFileUrl) {
        this.secondFastqFileUrl = secondFastqFileUrl;
        return this;
    }
    ...
    public Params withReadsFileName(String readsFileName) {
        this.readsFileName = readsFileName;
        return this;
    }
    ...
    public String toString() {
        return ((((((((((((((("Params"+" [workspaceName=")+ workspaceName)+", firstFastqFileName=")+ firstFastqFileName)+", secondFastqFileName=")+ secondFastqFileName)+", firstFastqFileUrl=")+ firstFastqFileUrl)+", secondFastqFileUrl=")+ secondFastqFileUrl)+", readsFileName=")+ readsFileName)+", additionalProperties=")+ additionalProperties)+"]");
    }
